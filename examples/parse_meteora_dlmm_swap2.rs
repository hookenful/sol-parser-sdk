//! Parse a specific Meteora DLMM Swap transaction from RPC
//!
//! This example fetches a Meteora DLMM Swap transaction from RPC
//! and parses it using sol-parser-sdk's RPC parsing support.
//!
//! Transaction: 3AN1kwPT4DpyhEcEmGUaoDzy8d1cUXsjFMYi3Fw7rWXnxnsSE5sEupPRdAqeybyDmRRW7GhsfNjFaFjYK91qnkgd
//!
//! Usage:
//! ```bash
//! cargo run --example parse_meteora_dlmm_swap2 --release
//! ```
...
fn main() {
    // 交易签名
    let tx_sig =
        "3AN1kwPT4DpyhEcEmGUaoDzy8d1cUXsjFMYi3Fw7rWXnxnsSE5sEupPRdAqeybyDmRRW7GhsfNjFaFjYK91qnkgd";

    println!("=== Meteora DLMM Swap2 Transaction Parser ===\n");
